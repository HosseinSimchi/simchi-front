...
@Component({
  selector: 'app-layout',
  imports: [HeaderComponent, SubHeaderComponent, ChartsSectionComponent, OrderChartComponent, RevenueProfileChartComponent, PipelineRadialChartComponent, RecentActivitiesComponent, GlobalHeatMapComponent, GetKnowUsComponent, TransactionStatusTableComponent],
